...
def off_diagonal_circuit(n, k1, k2, t, J, h, gamma_x=0, gamma_z=0, r=1, compute_real_part=True):
    assert k1 != k2
...
def run_lchs(n_x, t, J, h, gamma_x, gamma_z, r, K, M, num_samples_lchs, num_shots_lchs):
    ...
    for _ in range(num_samples_lchs):
        ...
        if j1 == j2:
            ...
            '''Off-diagonal terms'''
            circuit = off_diagonal_circuit(n_x, k[j1], k[j2], t, J, h, gamma_x, gamma_z, r)
        circuit.measure_all()
