...
if __name__ == "__main__":
    ...
    bell_basis_1q_gate_count = np.zeros((len(dimensions), len(error_tols)))
    bell_basis_2q_gate_count = np.zeros((len(dimensions), len(error_tols)))
    one_hot_1q_gate_count = np.zeros((len(dimensions), len(error_tols)))
    one_hot_2q_gate_count = np.zeros((len(dimensions), len(error_tols)))
